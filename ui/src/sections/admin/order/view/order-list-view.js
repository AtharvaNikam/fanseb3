...
export default function OrderListView() {
  ...
  const { orders, ordersLoading, ordersError, ordersEmpty, refreshOrder } = useGetOrders();
  ...
  const handleViewRow = useCallback(() => {
    router.push(paths.admin_dashboard.orders.details(viewOrderData.id));
  }, [router, viewOrderData.id]);
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            {
              name: 'Order',
              href: paths.admin_dashboard.orders.root,
            },
            { name: 'List' },
          ]}
          sx={{
