...
import { useGetBrandReviews } from 'src/api/reviews';
...
export default function ReviewsListView() {
  ...
  const { reviews, refreshReviews } = useGetBrandReviews(id);
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Reviews', href: paths.brand_dashboard.brands.reviews(id) },
            { name: 'List' },
          ]}
          // action={
          //   <Button
