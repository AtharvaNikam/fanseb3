...
import RegistrationForm from 'src/sections/main/register/view/register-form-influencer';
  ...
  const renderHead = (
    <Stack spacing={2} sx={{ mb: 2, ml: { md: 20, xs: 6 }, position: 'relative' }}>
      ...
      <Stack direction="row" spacing={0.5}>
        ...
        <Link href={paths.admin.login} component={RouterLink} variant="subtitle2">
          Sign in
        </Link>
      </Stack>
    </Stack>
